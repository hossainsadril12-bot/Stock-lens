# StockLens — UX Research, Feature Analysis & Ideate

**Module:** VantaTrack StockLens (Inventory)
**Source document:** StockLens PRD v3.0 (July 2026)
**Prepared by:** UX Design
**Stage:** Empathize + Define + **Ideate** (pre-wireframe)
**Status:** Working document
**Supersedes:** `2.0 StockLens_UX_Research_Feature_Analysis.md` — this version adds the completed Ideate stage (Section 13) and updates the stage tracker.
...
Read in this order: personas → feature list → journeys → problems → principles → **ideate**.
Everything after the journeys was *derived* from them, not invented. The Ideate section (13) was derived from the eight defined problems.
...
**Honest caveat before flowing.** Three concepts sit on top of blocking questions the product owner has not answered yet (Section 12): whether Phase 1 can add stock at all (Q1), whether the Items page defaults to all locations or one (Q2), and whether all five item types share one table (Q4). The Items list flow can begin now; the Add Item and Dashboard flows need those answers to be drawn truthfully.
...
| User flows — flow diagrams for the 9 Phase 1 screens | ⬜ Next |
| Prototype — paper sketches, then wireframes | ⬜ |
| Test — 3 users per round | ⬜ |

**Immediate next action:** send the 10 blocking questions to the product owner, then begin the Items list user flow using the four design concepts from Section 13.
